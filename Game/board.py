...
class Board(object):
    ...
    def __init__(self, board_w, board_h, piece_list):
        ...
        self._state = [[-1 for _ in range(board_w)] for _ in range(board_h)]
        self._legal = [[[True for _ in range(board_w)] for _ in range(board_h)] for _ in range(4)]
        self._connected = [[[False for _ in range(board_w)] for _ in range(board_h)] for _ in range(4)]
